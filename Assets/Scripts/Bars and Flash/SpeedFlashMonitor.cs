...
public class SpeedFlashMonitor : MonoBehaviour
{
    ...
    System.Collections.IEnumerator SwipeEffect()
    {
        ...
        Vector3 startPos = new(-screenWidth * swipeOffsetX, 0, 0);
        Vector3 endPos = new(screenWidth * swipeOffsetX, 0, 0);

        Color startColor = new(0f, 0.7f, 1f, 0f);
        Color fullColor = new(0f, 0.7f, 1f, maxAlpha);
