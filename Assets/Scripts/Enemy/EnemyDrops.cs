...
public class EnemyDrops : MonoBehaviour
{
    ...
    [Tooltip("Level threshold for guaranteed minimum quality")]
    public int waveThresholdForMediumDrops = 10;
    public int waveThresholdForLargeDrops = 20;
    ...
    private GameObject GetDropByQuality(GameObject[] drops)
    {
        ...
        int waveNumber = enemyManager != null ? enemyManager.GetWaveNumber() : 0;
